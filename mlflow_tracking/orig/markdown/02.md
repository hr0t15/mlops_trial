...
![Diagram showing Data Science and MLOps workflow with MLflow](https://mlflow.org/docs/latest/_images/quickstart_tracking_overview.png)
-->
...
For a comprehensive guide on getting an MLflow environment setup that will give you options on how to configure MLflow tracking capabilities, you can read the guide here.
-->
...
This example tries to optimize the RMSE metric of a Keras deep learning model on a wine quality dataset. It has two hyperparameters that it tries to optimize: learning_rate and momentum. We will use the [Hyperopt](https://github.com/hyperopt/hyperopt) library to run a hyperparameter sweep across different values of learning_rate and `momentum` and record the results in MLflow.

Before running the hyperparameter sweep, let’s set the `MLFLOW_TRACKING_URI` environment variable to the URI of our MLflow tracking server:
-->
...
If you would like to explore the possibilities of other tracking server deployments, including a fully-managed free-of-charge solution with Databricks Community Edition, please see this page.
...
![Screenshot of MLflow tracking UI table view showing runs](https://mlflow.org/docs/latest/_images/mlflow_ui_table_view.png)
...
![Screenshot of MLflow tracking UI parallel coordinates graph showing runs](https://mlflow.org/docs/latest/_static/images/quickstart_mlops/mlflow_ui_chart_view.png)
...
![Screenshot of MLflow tracking UI models page showing the registered model](https://mlflow.org/docs/latest/_images/register_model_button.png)
-->
